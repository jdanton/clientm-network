...
| [`proposed-working-design-5/`](proposed-working-design-5/) | **Two-firewall solution** — design-4's single 3-NIC NVA for inbound + Azure Firewall for egress. Answers "the client needs both firewall products in the architecture." NGFW-shape inbound preserved; FQDN-aware egress restored. ~$1,307/mo. **Deployed and verified end-to-end (7/7)** — see [VERIFIED.md](proposed-working-design-5/VERIFIED.md). |
